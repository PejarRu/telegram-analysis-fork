...
### GET `/apidocs/`
Swagger UI generated by Flasgger. Use it to explore the endpoints and response schemas interactively.

### GET `/metrics`
Prometheus metrics for request counts/latency (from `prometheus-flask-exporter`).
